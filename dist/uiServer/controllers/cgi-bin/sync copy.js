...
exports.default = (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { op, accessKeyId, accessKeySecret, bucket, region, destPath, } = ctx.request.body;
    ...
    if (op === 'push') {
        ...
        try {
            const importRulesResult = yield (0, rules_1.importAllRules)(hostname, {
                data: {
                    rules: rulesJSON,
                    replaceAll: 1,
                },
            });
            const importValuesResult = yield (0, values_1.importAllValues)(hostname, {
                data: {
                    rules: valuesJSON,
                    replaceAll: 1,
                },
